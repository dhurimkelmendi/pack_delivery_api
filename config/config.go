...
func (c *Config) readConfigs() {
	...
	c.DatabaseName = appConfig.GetConfig("DB_NAME", "pack_delivery_api_db")
	c.DatabaseUsername = appConfig.GetConfig("DB_USERNAME", "pack_delivery_api_backend")
	c.DatabasePassword = appConfig.GetConfig("DB_PASSWORD", "pack_delivery_api_password")
